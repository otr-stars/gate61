<div id="gallery" class="gallery">
    ...
    <div class="gallery-swiper swiper swiper--gallery">
        <div class="swiper-wrapper">
            <div class="swiper-slide" style="background-image: url('<?= wp_get_attachment_image_src(90, 'full')[0] ?>');"></div>
            <div class="swiper-slide" style="background-image: url('<?= wp_get_attachment_image_src(89, 'full')[0] ?>');"></div>
            <div class="swiper-slide" style="background-image: url('<?= wp_get_attachment_image_src(88, 'full')[0] ?>');"></div>
            <div class="swiper-slide" style="background-image: url('<?= wp_get_attachment_image_src(87, 'full')[0] ?>');"></div>
            <div class="swiper-slide" style="background-image: url('<?= wp_get_attachment_image_src(86, 'full')[0] ?>');"></div>
