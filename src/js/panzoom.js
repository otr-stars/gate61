            ...
            if (options.contain) {
                ...
                if (options.contain === 'inside') {
                    ...
                    options.minScale = Math.max(elemScaledWidth, elemScaledHeight);
								...
								console.log('w:' + parentWidth, ' h: ' + parentHeight);
            }
        }
        function constrainXY(toX, toY, toScale, panOptions) {
            ...
            if (opts.contain === 'inside') {
                ...
                result.y = Math.max(Math.min(result.y, maxY), minY);
								console.log(scaledHeight, realHeight, dims.parent.padding.top);
								//console.log('toX:' + toX + 'x:' + result.x);
								console.log('toY:' + toY + ', Y:' + result.y + ', maxY:' + maxY );
            }
            return result;
        }
